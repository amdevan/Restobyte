...
const ORDER_TYPES = ["All", "Dine In", "Delivery", "Pickup"];
const PAYMENT_METHODS = ["All", "Cash", "Card", "Online", "Other"];

const SalePage: React.FC = () => {
  const { sales, customers, tables, waiters } = useRestaurantData();
              ...
              <tbody className="bg-white divide-y divide-gray-200">
                {filteredSales.map(sale => (
                  <tr key={sale.id} className="hover:bg-gray-50 transition-colors">
                    ...
                    <td className="py-3 px-4 text-sm text-gray-800 font-semibold text-right">${sale.totalAmount.toFixed(2)}</td>
